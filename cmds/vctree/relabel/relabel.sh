...
python maskrcnn_benchmark/data/datasets/vg_new_relation.py \
    ...
    NEW_RELATION.REL_CACHE_PREFIX ${MODEL_NAME}_pretrain_tfidf_N$N \
    ...
    USE_LOGITS.LOGITS_COMB_PRIOR $OUTPUT_DIR/sup_data_with_${MODEL_NAME}_pred_comb_tfidf_N${N}_CD.pk \
    NEW_RELATION.TOP_K_FREQ $TOP_K_FREQ \
    NEW_RELATION.CLUSTER_TO_KNOWLEDGE triple_prob-context-distill-tfidf-no_new_rels-no_frequent_preds-N$N.pkl
