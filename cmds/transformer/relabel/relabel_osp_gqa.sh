...
python maskrcnn_benchmark/data/datasets/gqa_relation_deduction.py \
    ...
    USE_LOGITS.LOGITS_COMB_PRIOR $OUTPUT_DIR/sup_data_with_${MODEL_NAME}_pred_comb_N${N}_nCnD.pk \
    NEW_RELATION.USE_CONTEXT False \
    NEW_RELATION.USE_DISTILLATION False \
    NEW_RELATION.TOP_K_FREQ $TOP_K_FREQ \
    NEW_RELATION.NO_CONTEXT_TRIPLE_PROB triple_prob-freq_matrix-F1-N$N.pkl
