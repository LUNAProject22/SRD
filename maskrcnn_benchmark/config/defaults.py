...
# KG
# -----------------------------------------------------------------------------
_C.MODEL.KG = CN(new_allowed=True)
_C.MODEL.KG.MODE = "none" # context_freq/lp_no_context/lp_context/fc_lp_no_context_tail/none
_C.MODEL.CLIP_CKPT = ""
...
_C.TEST.RELATION.TEST_OVERLAP_THRES = 0.
...
_C.BBOX_XFORM_CLIP = math.log(1000. / 16.)

# For relabel
_C.USE_LOGITS = CN(new_allowed=True)
_C.USE_LOGITS.ENABLE = False

# Re-weighting
_C.WSUPERVISE = CN(new_allowed=True)
_C.WSUPERVISE.RWT = False

_C.GLOBAL_SETTING = CN()
_C.GLOBAL_SETTING.CHOOSE_BEST_MODEL_BY_METRIC = '_recall'
