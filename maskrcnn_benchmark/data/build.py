...
def get_dataset_statistics(cfg):
    ...
    # use vg training data statistics when eval model trained on vg,
    # even though the validation data is not vg. As model params (eg. LSTM dim) are decided by data
    ...
    result = {
        ...
        'freq_dist': statistics[0]['freq_dist'],
