...
class LPNoContextPredPredictor:
    def __init__(self, prior_file='data/kg_inference/logic_programming/prior_knowledge.pkl',
                 index_file='data/VisualGnome/preprocessed_codebase/VG-SGG-dicts.json', num_classes=151, knowledge_key='p(t,h,r)'):
        self.priors = pkl.load(open(prior_file, 'rb'))  # dict_keys(['p(r|h)_freq', 'p(r|h)', 'p(h)_freq', 'p(h)', 'p(t|h,r)', 'raw_mawtrix_rht'], p(t,h,r))
...
if __name__ == "__main__":
    predictor = LPNoContextPredPredictor(prior_file='data/kg_inference/prior_knowledge.pkl',
