...
class LPNoContextPredPredictor:
    def __init__(self, prior_file='data/kg_inference/matrix_pred_subj_obj/matrix_normalized_by_tails.pkl',
                 index_file='data/VisualGnome/preprocessed_codebase/VG-SGG-dicts.json', num_classes=151):
        self.matrix = pkl.load(open(prior_file, 'rb'))
        self.matrix = self.matrix.permute(1, 2, 0)
...
if __name__ == "__main__":
    predictor = LPNoContextPredPredictor(prior_file='datasets/kg/matrix_normalized_by_tails.pkl',
